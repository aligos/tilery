...
function storefront_scripts() {
	...
	wp_enqueue_script( 'storefront-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20120206', true );
	...
	wp_enqueue_script( 'storefront-jquery', get_template_directory_uri() . '/js/jquery.js', array(), '20130115', false );
