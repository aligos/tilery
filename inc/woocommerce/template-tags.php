	...
	function storefront_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'storefront' ); ?>">
				<span class="amount icon-line-basket"></span> <span class="count-tilery count"><?php echo wp_kses_data( sprintf( _n( '%d', '%d', WC()->cart->get_cart_contents_count(), 'storefront' ), WC()->cart->get_cart_contents_count() ) );?></span>
			</a>
		<?php
	}
	function love() {
		?>
			<a class="wishlistcount" href="/wordpress/suka/">
				<span class="amount icon-lined-heart"></span> <span id="wishlist-count" class="count-tilery count"><?php echo YITH_WCWL()->count_products(); ?></span>
			</a>
		<?php
	}
	function sstorefront_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'storefront' ); ?>">
